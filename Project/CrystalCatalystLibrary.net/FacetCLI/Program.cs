...
// Architecture: .NET 10 / SkiaSharp / Cross-Platform OS Hooks
...
static int Fail(string message)
{
    ...
    Console.Error.WriteLine("  FacetCLI capture [--display N] [--active-window]");
    Console.Error.WriteLine("           [--bounds x,y,w,h]");
    Console.Error.WriteLine("           [--format webp|png|jpeg] [--quality 1-100]");
    Console.Error.WriteLine("           [--grayscale]");
