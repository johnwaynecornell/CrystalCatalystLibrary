...
public class Pixels
{
    public static PixData CopyOrConvertPix(ref PixData pix, string pixformat_dest = "")
    {
        ...
        var Ret = Imports.Pixels_CopyOrConvertPix(ref pix, ref param_pixformat_dest);
        return Ret;
    }

    public static PixData CopyOrConvert(string pixformat, string pixformat_dest, IntPtr pixdata, IntPtr pixdata_length,
        int width, int height)
    {
        utf8_string_struct param_pixformat = pixformat;
        utf8_string_struct param_pixformat_dest = pixformat_dest;
        var Ret = Imports.Pixels_CopyOrConvert(ref param_pixformat, ref param_pixformat_dest, pixdata, pixdata_length,
            width, height);
        return Ret;
    }
    ...
    public class Imports
    {
        ...
        [DllImport("CrystalCatalystLibrary")]
        public static extern PixData Pixels_CopyOrConvert(ref utf8_string_struct pixformat,
