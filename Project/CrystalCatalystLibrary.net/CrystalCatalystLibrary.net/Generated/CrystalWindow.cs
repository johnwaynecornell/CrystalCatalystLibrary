...
public partial class CrystalWindow
{
    ...
    {
        Imports.CrystalWindow_ClipboardCopyWithCallback((ClipboardCopyWithCallback_provide)provide, data.Handle);
    }
    ...
    public static CrystalWindow Create(int  width, int  height, string  title)
    {
        ...
        return new CrystalWindow(Imports.CrystalWindow_Create((int)width, (int)height,  ref param_title));
    }
    public static CrystalWindow CreateSimple(int  width, int  height, string  title)
    {
        utf8_string_struct param_title = title;
        return new CrystalWindow(Imports.CrystalWindow_CreateSimple((int)width, (int)height,  ref param_title));
    }
