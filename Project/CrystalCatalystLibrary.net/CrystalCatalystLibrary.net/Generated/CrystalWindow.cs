...
public partial class CrystalWindow : IDisposable
{
    ...
    {
        DataInterchange Ret = (DataInterchange)Imports.CrystalWindow_ClipboardPaste(Handle);
        return Ret;
    }
    ...
    {
        return (IntPtr data) => { callback((DataInterchange)data); }
            ;
    }
    ...
    public static CrystalWindow Create(int width, int height, string title)
    {
        ...
        CrystalWindow Ret = (CrystalWindow)Imports.CrystalWindow_Create((int)width, (int)height, ref param_title);
        return Ret;
    }
    ...
    {
        utf8_string_struct param_title = title;
        CrystalWindow Ret = (CrystalWindow)Imports.CrystalWindow_CreateSimple((int)width, (int)height, ref param_title);
        return Ret;
    }
    ...
    public void PresentImage(string pixformat, IntPtr pixdata, IntPtr pixdata_length, int width, int height)
    {
        ...
        Imports.CrystalWindow_PresentImage(Handle, ref param_pixformat, (IntPtr)pixdata, (IntPtr)pixdata_length,
            (int)width, (int)height);
    }

    public void CursorPix(ref PixData pix, int hot_x, int hot_y)
    {
        Imports.CrystalWindow_CursorPix(Handle, ref pix, (int)hot_x, (int)hot_y);
    }
    ...
    {
        utf8_string_struct param_pixformat = pixformat;
        Imports.CrystalWindow_SetCursor(Handle, ref param_pixformat, (IntPtr)pixdata, (IntPtr)pixdata_length,
            (int)width, (int)height, (int)hot_x, (int)hot_y);
    }

    public void SetStandardCursor(CrystalCursor cursor_enum)
    {
        Imports.CrystalWindow_SetStandardCursor(Handle, (CrystalCursor)cursor_enum);
    }
    ...
    {
        utf8_string_struct param_pixformat = pixformat;
        Imports.CrystalWindow_SetIcon(Handle, ref param_pixformat, (IntPtr)pixdata, (IntPtr)pixdata_length, (int)width,
            (int)height);
    }
    ...
    {
        bool Ret = (bool)Imports.CrystalWindow_GLInitVersioned(Handle, (int)major, (int)minor);
        return Ret;
    }

    public bool GLInitAdvanced(GLOptions options)
    {
        bool Ret = (bool)Imports.CrystalWindow_GLInitAdvanced(Handle, (GLOptions)options);
        return Ret;
    }
    ...
    public nint GLGetProcAddress(string name)
    {
    ...
    {
        Imports.CrystalWindow_SetSize(Handle, (int)width, (int)height);
    }
    ...
    {
        Imports.CrystalWindow_SetLocation(Handle, (int)x, (int)y);
    }
    ...
    public bool SetMessageHandler(string handler_name, IntPtr handler)
    {
        ...
        bool Ret = (bool)Imports.CrystalWindow_SetMessageHandler(Handle, ref param_handler_name, (IntPtr)handler);
        return Ret;
    }

    public double uptimeSeconds()
    {
        double Ret = (double)Imports.CrystalWindow_uptimeSeconds(Handle);
        return Ret;
    }
    ...
    {
        return (IntPtr window_handle) => { callback((CrystalWindow)window_handle); }
            ;
    }
    ...
    public Delegate_on_draw? OnDraw
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_draw);
    ...
    {
        return (IntPtr window_handle, int keycode) => { callback((CrystalWindow)window_handle, (int)keycode); }
            ;
    }
    ...
    public Delegate_on_key_down? OnKeyDown
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_key_down);
    ...
    public Delegate_on_key_up? OnKeyUp
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_key_up);
    ...
    {
        return (IntPtr window_handle, int x, int y) => { callback((CrystalWindow)window_handle, (int)x, (int)y); }
            ;
    }
    ...
    public Delegate_on_mouse_move? OnMouseMove
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_mouse_move);
    ...
    public Delegate_on_mouse_down? OnMouseDown
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_mouse_down);
    ...
    public Delegate_on_mouse_up? OnMouseUp
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_mouse_up);
    ...
    public delegate void Delegate_on_mouse_enter(CrystalWindow window_handle);

    protected static Imports.Delegate_on_mouse_enter TranslateDelegate_on_mouse_enter(Delegate_on_mouse_enter callback)
    {
        return (IntPtr window_handle) => { callback((CrystalWindow)window_handle); }
            ;
    }

    private Imports.Delegate_on_mouse_enter? native_on_mouse_enter;
    private Delegate_on_mouse_enter? delegate_on_mouse_enter;

    public Delegate_on_mouse_enter? OnMouseEnter
    {
        set
        {
            if (value == null)
            {
                native_on_mouse_enter = null;
                delegate_on_mouse_enter = null;
                SetMessageHandler("on_mouse_enter", IntPtr.Zero);
                return;
            }

            native_on_mouse_enter = TranslateDelegate_on_mouse_enter(value);
            delegate_on_mouse_enter = value;
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_mouse_enter);
            SetMessageHandler("on_mouse_enter", pointerToNative);
        }

        get => delegate_on_mouse_enter;
    }

    public delegate void Delegate_on_mouse_leave(CrystalWindow window_handle);

    protected static Imports.Delegate_on_mouse_leave TranslateDelegate_on_mouse_leave(Delegate_on_mouse_leave callback)
    {
        return (IntPtr window_handle) => { callback((CrystalWindow)window_handle); }
            ;
    }

    private Imports.Delegate_on_mouse_leave? native_on_mouse_leave;
    private Delegate_on_mouse_leave? delegate_on_mouse_leave;

    public Delegate_on_mouse_leave? OnMouseLeave
    {
        set
        {
            if (value == null)
            {
                native_on_mouse_leave = null;
                delegate_on_mouse_leave = null;
                SetMessageHandler("on_mouse_leave", IntPtr.Zero);
                return;
            }

            native_on_mouse_leave = TranslateDelegate_on_mouse_leave(value);
            delegate_on_mouse_leave = value;
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_mouse_leave);
            SetMessageHandler("on_mouse_leave", pointerToNative);
        }

        get => delegate_on_mouse_leave;
    }
    ...
    public Delegate_on_resize? OnResize
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_resize);
    ...
    public Delegate_on_close? OnClose
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_close);
    ...
    public Delegate_on_focus_in? OnFocusIn
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_focus_in);
    ...
    public Delegate_on_focus_out? OnFocusOut
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_focus_out);
    ...
    {
        return (IntPtr window_handle, IntPtr data) => { callback((CrystalWindow)window_handle, (DragDropData)data); }
            ;
    }
    ...
    public Delegate_on_drag_receive_start? OnDragReceiveStart
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_drag_receive_start);
    ...
    public Delegate_on_drag_receive_enter? OnDragReceiveEnter
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_drag_receive_enter);
    ...
    public Delegate_on_drag_receive_motion? OnDragReceiveMotion
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_drag_receive_motion);
    ...
    public Delegate_on_drag_receive_leave? OnDragReceiveLeave
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_drag_receive_leave);
    ...
    public Delegate_on_drag_receive_drop? OnDragReceiveDrop
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_drag_receive_drop);
    ...
    public Delegate_on_drag_receive_select? OnDragReceiveSelect
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_drag_receive_select);
    ...
    public Delegate_on_drag_provide_status? OnDragProvideStatus
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_drag_provide_status);
    ...
    public Delegate_on_drag_provide_chosen? OnDragProvideChosen
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_drag_provide_chosen);
    ...
    public Delegate_on_drag_provide_finished? OnDragProvideFinished
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_drag_provide_finished);
    ...
    public Delegate_on_clipboard_provide_chosen? OnClipboardProvideChosen
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_clipboard_provide_chosen);
    ...
    {
        return (IntPtr window_handle, IntPtr data) => { callback((CrystalWindow)window_handle, (DataInterchange)data); }
            ;
    }
    ...
    public Delegate_on_clipboard_receive_data? OnClipboardReceiveData
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_clipboard_receive_data);
    ...
    public Delegate_on_idle? OnIdle
    {
        set
        {
            ...
            IntPtr pointerToNative = Marshal.GetFunctionPointerForDelegate(native_on_idle);
    ...
    public class Imports
    {
        ...
        [DllImport("CrystalCatalystLibrary")]
        public static extern IntPtr CrystalWindow_GLGetProcAddress(IntPtr window_handle, string name);
        ...
        [DllImport("CrystalCatalystLibrary")]
        public static extern void CrystalWindow_Activate(IntPtr window_handle);
        ...
        public delegate void Delegate_on_mouse_enter(IntPtr window_handle);

        // void (*on_mouse_leave)(P_INSTANCE WindowHandle window_handle)
        public delegate void Delegate_on_mouse_leave(IntPtr window_handle);
