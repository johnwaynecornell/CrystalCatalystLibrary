...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        wnd.OnMouseEnter = (handle) => { entered = true; };

        wnd.OnMouseLeave = (handle) => { entered = false; };
        ...
        wnd.OnIdle = handle =>
        {
            ...
            if (time - lastTime >= 1.0 / fps)
            {
                ...
                
                {
                    ...
                    if (entered) wnd.CursorPix(ref cursor_pixdata, (int)translateHotSpot.X, (int)translateHotSpot.Y);
                    cursor_pixdata.Dispose();
                }
