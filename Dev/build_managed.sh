...
newage_managed_build_directory Project/CrystalCatalystLibrary.net
newage_managed_build_directory CrystalOptics/Project/CrystalOptics.net
newage_managed_build_directory Project/ClipFlowPack
